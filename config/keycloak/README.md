...
Create a client: https://www.keycloak.org/docs-api/4.0/rest-api/index.html#_clientrepresentation
```bash
curl -X POST 'http://accounts.d10l.de/auth/admin/realms/d10l/clients' \
-H "Content-Type: application/json" \
-H "Authorization: Bearer eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICI0SHJMTEhrTDNlZTVtaWtFWXo1eVFqR0hZVmxXZUJMcGpBS1pVcG5WLUtvIn0..rKS12SCAHX7yEZLN6IuaZxXtDN4__mta8emK4pA3-xrnicVToCovppyjX8PzkWBUNJlnzqMfR8Op5NeWVMMJhssp0R0EN9Vy_fFIKoVGhOaZ9vv0OuHzoA7XlJUWaNXP4HhvlIZTS6E3WOWbegOkeWrjjj1htMAjkAaV7DKcxQPp_sagVBCWgKFF3NECdYZkOsXDd5i1mkZBgcfCLiHiWuaT1H1HgOUFb0K3q1-AzyhbrGSRiQoYc4CAkqkb8Rv4u3pI8-2a_uY3stbMeM17lYQxWspSKqJCJZIW6dDjKa9NkCGvKSSQLRJKq0R4AjNZZDpMRkQjZH0jq9OoO8DfeQ" \
-d '{
	"clientId": "test-id",
	"name": "SuperApp",
	"consentRequired": "true",
	"redirectUris": ["http://open.d10l.de"]
}'
```
